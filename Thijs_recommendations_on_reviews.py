...
# When looking at the data is became clear that it is structured in eleven different catagories. The first three being the
...
Y = []
nameoffilm = "the-hitmans-bodyguard"
for i in range(0,1000):
    if movies[i][0] == nameoffilm:
        Y += [movies[i][2]]
